...
class ProductTemplate(models.Model):
        ...
        if self.categ_id:
            ...
            for product in same_category_products:
                ...
                if 1.2 <= price_ratio <= 3.0:
                    score = 100 - abs(price_ratio - 1.5) * 20
    ...
    def action_generate_all_upsell(self):
        ...
        return {
            ...
            "params": {
                "title": _(u"Upsell Generation Complete"),
                "message": _(u"Generated %d upsell recommendations for %d products")
    ...
    def action_view_recommendations(self):
        ...
        return {
            "type": "ir.actions.act_window",
            "name": _(u"Product Recommendations"),
